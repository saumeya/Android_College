...
package com.saumeya.retailapp.util;
...
import com.saumeya.retailapp.view.fragment.ContactUsFragment;
import com.saumeya.retailapp.view.fragment.HomeFragment;
import com.saumeya.retailapp.view.fragment.MyCartFragment;
import com.saumeya.retailapp.view.fragment.MyOrdersFragment;
import com.saumeya.retailapp.view.fragment.ProductOverviewFragment;
import com.saumeya.retailapp.view.fragment.MyWishlistFragment;
...
public class Utils {
    ...
    public final static String ORDERS_LIST_TAG = "OrdersList";
    ...
    public static final String WISH_LIST_TAG = "MyWishlistFragment";
        ...
        if (CURRENT_TAG == null || !TAG.equals(CURRENT_TAG)) {
            ...
            if (fragment == null) {
                ...
                if (TAG.equals(HOME_FRAGMENT)) {
                    ...
                    fragmentToReplace = new MyCartFragment();
                }else if (TAG.equals(ORDERS_LIST_TAG)) {
                    fragmentToReplace = new MyOrdersFragment();
                }else if (TAG.equals(WISH_LIST_TAG)) {
                    fragmentToReplace = new MyWishlistFragment();
                }
