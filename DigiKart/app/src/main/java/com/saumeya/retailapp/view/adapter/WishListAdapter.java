...
import com.saumeya.retailapp.view.customview.ItemTouchHelperAdapter;
...
import com.saumeya.retailapp.view.customview.TextDrawable.IBuilder;
...
public class WishListAdapter extends
        RecyclerView.Adapter<WishListAdapter.ItemViewHolder> implements
    ...
    public WishListAdapter(Context context,
        ...
        productList = CenterRepository.getCenterRepository().getListOfProductsInWishList();
    }

    @Override
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.wishlist_product_list, parent, false);
    ...
    public void onBindViewHolder(final ItemViewHolder holder, final int position) {
        ...
        holder.quanitity.setText(CenterRepository.getCenterRepository()
                .getListOfProductsInWishList().get(position).getQuantity());
    ...
    public void onItemDismiss(int position) {
        ...
        ((ECartHomeActivity) context).updateCheckOutAmount(
                BigDecimal.valueOf(Long.valueOf(CenterRepository
                        .getCenterRepository().getListOfProductsInWishList().get(position)
                        .getSellMRP())), false);

        CenterRepository.getCenterRepository().getListOfProductsInWishList().remove(position);
