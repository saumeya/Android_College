...
public class ProductListAdapter extends
    ...
    public void onBindViewHolder(final VersionViewHolder holder,
        ...
        holder.wishlist.findViewById(R.id.wish_list).setOnClickListener(
                new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (CenterRepository.getCenterRepository()
                                .getListOfProductsInWishList().contains(tempObj)) {
                            Toast.makeText(getContext(),"Already in Wishlist",Toast.LENGTH_SHORT).show();

                        } else {
                            CenterRepository.getCenterRepository()
                                    .getListOfProductsInWishList().add(tempObj);
    ...
    class VersionViewHolder extends RecyclerView.ViewHolder implements
        ...
        public VersionViewHolder(View itemView) {
            ...
            wishlist = ((TextView) itemView.findViewById(R.id.wish_list));
